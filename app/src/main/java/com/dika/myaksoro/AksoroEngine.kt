...
class AksoroEngine(private val context: Context) {
    ...
    init {
        ...
        try {
            val cnnPath = assetFilePath(context, "mobilenetv2_aksoro_final.ptl") // Ganti jika nama filemu berbeda
    ...
    fun processImage(bitmap: Bitmap): PipelineResult {
        ...
        // TODO 3: Looping hasil MobileNetV2 ke PyTorch Seq2Seq LSTM
        val dummyLstmString = "Menunggu implementasi Seq2Seq..."

        return PipelineResult(
            cnnOutput = cnnResults,
            lstmOutput = dummyLstmString,
            // debugCrop = if (segmentedBitmaps.isNotEmpty()) segmentedBitmaps[0] else null,
